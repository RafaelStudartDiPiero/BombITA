...
class Block(pygame.sprite.Sprite):
    def __init__(self, game):
        ...
        self.img = pygame.transform.scale(self.img, (self.game.cell_width, self.game.cell_height))
    ...
    def update(self):
        ...
        while self.free == False:
            self.grid_pos = vector(random.randint(0, X_CELLS - 1), random.randint(0, Y_CELLS - 1))
            self.free = True
        ...
        self.rect.center = vector(self.grid_pos.x * self.game.cell_width + self.game.cell_width / 2,
                              self.grid_pos.y * self.game.cell_height + self.game.cell_height / 2)
